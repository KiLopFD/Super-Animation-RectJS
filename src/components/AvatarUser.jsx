...
const AvatarUser = () => {
    ...
    const [userCookie, setUserCookie, removeCookie] = useCookies(["token"])
        ...
        /> */}
                            <div className="wrap-avatar cursor-pointer">
                                <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <circle cx="18" cy="15" r="4.5" fill="#FFFEFE" />
                                    <circle cx="18" cy="18" r="13.5" stroke="#FFFEFE" strokeWidth="1.2" />
                                    <path d="M26.8078 28.2124C26.9233 28.1202 26.9699 27.9654 26.9178 27.827C26.354 26.3277 25.2201 25.0059 23.6721 24.0499C22.0449 23.0448 20.0511 22.5 18 22.5C15.9489 22.5 13.9551 23.0448 12.3279 24.0498C10.7799 25.0059 9.64599 26.3277 9.08216 27.827C9.03013 27.9654 9.07672 28.1202 9.1922 28.2124V28.2124C14.3429 32.3279 21.6571 32.3279 26.8078 28.2124V28.2124Z" fill="white" stroke="#FFFEFE" strokeWidth="1.2" strokeLinecap="round" />
                                </svg>

                            </div>
                        </MenuHandler>
                        <MenuList className='relative z-50 min-w-[200px]'>
